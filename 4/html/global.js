...
switch(pg_id){
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1280" height="726" alt=""></div><div class="ref_pop"><img src="slide3/2.png" width="1280" height="726" alt=""/></div><div class="hit_ref" onclick="hit_ref()"></div><div class="api_pop"><img src="slide3/3.png" width="1280" height="726" alt=""/></div><div class="hit_api" onclick="hit_api()"></div><div class="hit_close" onclick="hit_close()"></div><div class="takeHome" onclick="takeHome();"></div>';
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/1.jpg" width="1280" height="726" alt=""></div><div class="ref_pop"><img src="slide3/2.png" width="1280" height="726" alt=""/></div><div class="hit_ref" onclick="hit_ref()"></div><div class="api_pop"><img src="slide3/3.png" width="1280" height="726" alt=""/></div><div class="hit_api" onclick="hit_api()"></div><div class="hit_close" onclick="hit_close()"></div><div class="takeHome" onclick="takeHome();"></div>';
	break;
}

...
switch(pg_id){
	...
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/1.jpg" width="1280" height="726" alt=""></div><div class="hit_1"><img src="slide3/2.png" width="1280" height="726" alt=""/></div><div class="hit_pop1" onclick="hit_pop1()"></div><div class="ref_pop"><img src="slide4/2.png" width="1280" height="726" alt=""/></div><div class="hit_ref" onclick="hit_ref()"></div><div class="api_pop"><img src="slide4/3.png" width="1280" height="726" alt=""/></div><div class="hit_api" onclick="hit_api()"></div><div class="hit_close" onclick="hit_close()"></div><div class="hit_close" onclick="hit_close()"></div><div class="takeHome" onclick="takeHome();"></div>';
	break;
	case 4:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide4.css" media="screen"/><div class="background"><img src="slide4/1.jpg" width="1280" height="726" alt=""></div><div class="ref_pop"><img src="slide4/2.png" width="1280" height="726" alt=""/></div><div class="hit_ref" onclick="hit_ref()"></div><div class="api_pop"><img src="slide4/3.png" width="1280" height="726" alt=""/></div><div class="hit_api" onclick="hit_api()"></div><div class="hit_close" onclick="hit_close()"></div><div class="takeHome" onclick="takeHome();"></div>';
	break;
}
